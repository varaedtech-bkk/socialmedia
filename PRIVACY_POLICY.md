...
- Social media account details (for example, Page ID, Access Token) when linking accounts
- Content you upload, schedule, or publish through our platform

### b) Information Collected Automatically:
- Log data (for example, IP address, device information, browser type)
- Usage data (for example, interactions with our platform, pages visited)

### c) Information from Third-Party Services:
- When you connect your social media accounts, we may receive certain data based on your permissions (for example, access to pages, publishing rights)
...
- **With service providers:** Who assist us in operating and improving our platform (for example, hosting, analytics)
